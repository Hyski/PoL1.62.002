...
//=====================================================================================//
void CriticalSection::enter() volatile
{
	m_optex.Enter();
}
...
//=====================================================================================//
void CriticalSection::leave() volatile
{
	m_optex.Leave();
}
