...
/*
===============================
    Здесь собраны классы для обработки ошибок библиотеки в 
    виде исключений. Все классы - ошибки объединены иерархией 
    наследования
===============================
*/
...
//ошибки лексера (сканера)
//
class LexerErr: public PCCTS_Err{};

//ошибки токенов 
//
class TokenErr: public PCCTS_Err{};

//ошибки TokenBuffer'a
//
class TokBufferErr: public PCCTS_Err{};

//ошибки парсера
//
class ParserErr: public PCCTS_Err{};
