...
//Punch                "%s near line %d (text was '%s')\n",
//Punch                ((s == NULL) ? "Lexical error" : s),
//Punch                _line,_lextext);
}
...
//Punch	fprintf(stderr,"No input stream, function, or string\n");
...
//Punch	fprintf(stderr, "DLG panic: %s\n", msg);
//
//  7-Apr-97 133MR1
//
